...
const Strategies: React.FC = () => {
  ...
  const handleAddStrategy = async () => {
    ...
    const existingStrategies = getUniqueStrategies();
    ...
    try {
      // Create the new strategy with type 'live'
  ...
  const handleDuplicateStrategy = async () => {
    ...
    try {
      // Create the duplicate strategy with type 'live'
      await createStrategy(duplicateName, 'live');
            ...
            <div className="max-w-7xl mx-auto">
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="flex items-center bg-black/5 rounded-lg p-4">
